...
<div class="holidaysm">
	...
	<div id="nav">
		...
		<h5 style="position:relative;top:37px;left:160px"> Filtrer </h5>
		<div style="position:relative;top:30px;left:170px">
			<form method='get' >
		  ...
		  <select id="filtre" name='id' class="form-control">
			...
			<button type="submit" class="btn btn-default" style="position:relative;top:-38px;left:210px;">OK</button>
		</form>
		</div>
	</div>
